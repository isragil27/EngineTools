...
public class ControlRecursos extends AppCompatActivity {
    ...
    protected AdapterView.OnItemClickListener ItemListener()
    {
        return new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                {
                    case 0:
                        Intent intentElectr= new Intent(getApplicationContext(),DiagBloq.class);
                        startActivity(intentElectr);
                        break;
                    case 1:
                        Intent intentcapacitor=new Intent(getApplicationContext(),SPO.class);
                        startActivity(intentcapacitor);
                        break;
                    case 2:
                        Intent intentampop=new Intent(getApplicationContext(),SSO.class);
